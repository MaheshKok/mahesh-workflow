...
- `continuous-agent-loop` for a bounded workflow specification with explicit quality gates and stop conditions
- `agentic-engineering` for independently verifiable work items and acceptance checks
